import{o as e}from"./rolldown-runtime-DAXXjFlN.js";import{n as t,r as n}from"./jsx-runtime-BJvgpPfO.js";import{A as r,Ar as i,Br as a,Hr as o,Ht as s,K as c,Mt as l,Nt as u,Or as d,S as f,Ur as p,Vr as m,Wr as h,ht as g,kr as _,v}from"./index.browser-IPlrPleG.js";import{Cu as y,bp as b,du as x,fp as S,pt as ee}from"./app-server-manager-signals-BqYsh4nk.js";import{B as C,C as w,D as T,F as E,H as te,O as D,P as O,Z as k}from"./reduced-motion-preference-M5PMNiMW.js";import{t as ne}from"./useQuery-ComjgUD2.js";import{Zt as re}from"./thread-panel-state-CtMHvB7J.js";import{p as A}from"./mime-types-BNREMq9l.js";import{s as j}from"./x-CR007vvl.js";import{t as M}from"./use-platform-BVwxpmyv.js";import{t as ie}from"./availability.browser-CsHyJftD.js";import{o as N,r as ae}from"./use-auth-BC45FIlP.js";import{t as oe}from"./use-codex-home-DvT5XOeq.js";import{t as P}from"./use-chatgpt-account-info-DkO_rcr3.js";var se=e(n(),1),F=t(),I=`app://fs`,L=`/@fs`;function ce(e){return`${I}${le(e)}`}function R(e){return le(e)}function le(e){let t=p(h(e));return`${L}${encodeURI(t).replaceAll(`#`,`%23`).replaceAll(`?`,`%3F`)}`}var ue=100,de=[`experimental-features`,`list`];async function fe(e){return b({hostId:e,method:`experimentalFeature/list`,request:async t=>{let n=[],r=null;do{let i=await S(`list-experimental-features`,{hostId:e,cursor:r,limit:ue,trace:t});n.push(...i.data),r=i.nextCursor??null}while(r!=null);return n},source:`features`})}var z=k(E,e=>({queryKey:[...de,e],queryFn:async()=>{try{return await fe(e)}catch(e){return c.error(`Failed to load experimental features`,{safe:{error:String(e)},sensitive:{}}),[]}},staleTime:O.ONE_MINUTE}));function B(e){let t=(0,F.c)(12),{hostId:n,featureName:r,defaultEnabled:i,enabled:a}=e,o=i===void 0||i,s=a===void 0||a,c;t[0]===s?c=t[1]:(c={enabled:s},t[0]=s,t[1]=c);let{data:l,isLoading:u}=C(z,n,c),d;t[2]===l?d=t[3]:(d=l===void 0?[]:l,t[2]=l,t[3]=d);let f=d,p;if(t[4]!==r||t[5]!==f){let e;t[7]===r?e=t[8]:(e=e=>e.name===r,t[7]=r,t[8]=e),p=f.find(e),t[4]=r,t[5]=f,t[6]=p}else p=t[6];let m=s&&(p?.enabled??o),h;return t[9]!==u||t[10]!==m?(h={enabled:m,isLoading:u},t[9]=u,t[10]=m,t[11]=h):h=t[11],h}function V(e){return e===`macOS`||e===`windows`}function pe(e){let t=(0,F.c)(17),{enabled:n,hostId:r}=e,i=n===void 0||n,{isLoading:a,platform:o}=M(),s=j(`1506311413`),c;t[0]!==i||t[1]!==r?(c={enabled:i,featureName:`computer_use`,hostId:r},t[0]=i,t[1]=r,t[2]=c):c=t[2];let l=B(c),u=o===`windows`&&!a,d=i&&u,f;t[3]===d?f=t[4]:(f={enabled:d},t[3]=d,t[4]=f);let p=H(f),m=l.isLoading||u&&p.isLoading,h=l.enabled&&(!u||p.enabled),g;t[5]!==h||t[6]!==i||t[7]!==m||t[8]!==s||t[9]!==a||t[10]!==o?(g=W({areRequiredFeaturesEnabled:h,enabled:i,isAnyFeatureLoading:m,isComputerUseGateEnabled:s,isHostCompatiblePlatform:V(o),isPlatformLoading:a,windowType:`chrome-extension`}),t[5]=h,t[6]=i,t[7]=m,t[8]=s,t[9]=a,t[10]=o,t[11]=g):g=t[11];let _=g,v=_===`available`,y=_===`loading`&&m,b=_===`loading`,x;return t[12]!==_||t[13]!==v||t[14]!==y||t[15]!==b?(x={available:v,isFetching:y,isLoading:b,reason:_},t[12]=_,t[13]=v,t[14]=y,t[15]=b,t[16]=x):x=t[16],x}function H(e){let t=(0,F.c)(21),{enabled:n}=e,i=(0,se.useContext)(N)?.authMethod===`chatgpt`,a;t[0]===Symbol.for(`react.memo_cache_sentinel`)?(a=[`accounts`,`check`],t[0]=a):a=t[0];let o=n&&i,s;t[1]===o?s=t[2]:(s={queryKey:a,queryFn:U,staleTime:O.ONE_MINUTE,enabled:o},t[1]=o,t[2]=s);let{data:c,errorUpdatedAt:l,isLoading:u}=ne(s),d=c?.account_ordering?.[0],f;t[3]!==c?.accounts||t[4]!==d?(f=c?.accounts?.find(e=>e.id===d),t[3]=c?.accounts,t[4]=d,t[5]=f):f=t[5];let p=f,m=p==null&&(!u||l!==0),h=n&&i&&m,g;t[6]===h?g=t[7]:(g={enabled:h},t[6]=h,t[7]=g);let{data:_,isLoading:v}=P(g),y=p?.id??(m?_?.accountId:void 0),b=p?.plan_type??(m?_?.plan:void 0),x=i?b:void 0,S;t[8]===x?S=t[9]:(S=re(x),t[8]=x,t[9]=S);let ee=S,C;t[10]===y?C=t[11]:(C=[`accounts`,`settings`,y],t[10]=y,t[11]=C);let w=n&&y!=null&&ee&&i,T;t[12]===y?T=t[13]:(T=async()=>r.safeGet(`/accounts/{account_id}/settings`,{parameters:{path:{account_id:y??``}}}),t[12]=y,t[13]=T);let E;t[14]!==w||t[15]!==T||t[16]!==C?(E={queryKey:C,enabled:w,queryFn:T,staleTime:O.ONE_MINUTE},t[14]=w,t[15]=T,t[16]=C,t[17]=E):E=t[17];let{data:te,isLoading:D}=ne(E),k=!i||b!=null&&(!ee||(te?.beta_settings?.windows_computer_use??!1)),A=n&&i&&(u&&!m||v||D),j;return t[18]!==k||t[19]!==A?(j={enabled:k,isLoading:A},t[18]=k,t[19]=A,t[20]=j):j=t[20],j}async function U(){return r.safeGet(`/wham/accounts/check`)}function W({areRequiredFeaturesEnabled:e,enabled:t,isAnyFeatureLoading:n,isComputerUseGateEnabled:r,isHostCompatiblePlatform:i,isPlatformLoading:a,windowType:o}){return t?o===`electron`?r?a?`loading`:i?n?`loading`:e?`available`:`config-requirement-disabled`:`unsupported-platform`:`statsig-disabled`:`window-type-disabled`:`disabled`}function me(e){let t=(0,F.c)(14),{enabled:n,hostId:r,windowType:i}=e,a=n===void 0||n,o=i===void 0?`chrome-extension`:i,s=j(`410065390`),c;t[0]!==a||t[1]!==r?(c={enabled:a,featureName:`browser_use_external`,hostId:r},t[0]=a,t[1]=r,t[2]=c):c=t[2];let l=B(c),u=w(g.runCodexInWsl),d=A(r),f=u===!0||d.kind===`wsl`,p;t[3]!==l.enabled||t[4]!==l.isLoading||t[5]!==s||t[6]!==f||t[7]!==o?(p=G({isExternalBrowserUseFeatureEnabled:l.enabled,isExternalBrowserUseFeatureLoading:l.isLoading,isExternalBrowserUseGateEnabled:s,runCodexInWsl:f,windowType:o}),t[3]=l.enabled,t[4]=l.isLoading,t[5]=s,t[6]=f,t[7]=o,t[8]=p):p=t[8];let m=p,h=m===`available`,_=m===`available`,v=m===`loading`,y;return t[9]!==m||t[10]!==h||t[11]!==_||t[12]!==v?(y={allowed:h,available:_,isLoading:v,reason:m},t[9]=m,t[10]=h,t[11]=_,t[12]=v,t[13]=y):y=t[13],y}function G({isExternalBrowserUseFeatureEnabled:e,isExternalBrowserUseFeatureLoading:t,isExternalBrowserUseGateEnabled:n,runCodexInWsl:r,windowType:i}){return i===`chrome-extension`?`available`:t?`loading`:n?e?r?`wsl-disabled`:`available`:`config-requirement-disabled`:`statsig-disabled`}function he(e){let t=(0,F.c)(14),{enabled:n,hostId:r}=e,i=n===void 0||n,a=te(ie),o=j(`410262010`),s;t[0]!==i||t[1]!==r?(s={enabled:i,featureName:`browser_use`,hostId:r},t[0]=i,t[1]=r,t[2]=s):s=t[2];let c=B(s),l=w(g.runCodexInWsl),u=A(r),d=c.enabled&&!c.isLoading,f=c.isLoading,p=l===!0||u.kind===`wsl`,m;t[3]!==o||t[4]!==a||t[5]!==d||t[6]!==f||t[7]!==p?(m=K({isBrowserAgentGateEnabled:o,isBrowserSidebarEnabled:a,isBrowserUseEnabled:d,isLoading:f,runCodexInWsl:p,windowType:`chrome-extension`}),t[3]=o,t[4]=a,t[5]=d,t[6]=f,t[7]=p,t[8]=m):m=t[8];let h=m,_=h===`available`,v=h===`available`,y=h===`loading`,b;return t[9]!==h||t[10]!==_||t[11]!==v||t[12]!==y?(b={allowed:_,available:v,isLoading:y,reason:h},t[9]=h,t[10]=_,t[11]=v,t[12]=y,t[13]=b):b=t[13],b}function K({isBrowserAgentGateEnabled:e,isBrowserSidebarEnabled:t,isBrowserUseEnabled:n,isLoading:r,runCodexInWsl:i,windowType:a}){return a===`chrome-extension`?`window-type-disabled`:r?`loading`:t?e?n?i?`wsl-disabled`:`available`:`config-requirement-disabled`:`statsig-disabled`:`browser-pane-disabled`}var ge=`plugins`;function _e(e){let t=(0,F.c)(6),{enabled:n,hostId:r}=e,i=n===void 0||n,a;t[0]===i?a=t[1]:(a={enabled:i},t[0]=i,t[1]=a);let{data:o}=C(z,r,a),s;t[2]===o?s=t[3]:(s=o===void 0?[]:o,t[2]=o,t[3]=s);let c=s,l;return t[4]===c?l=t[5]:(l=c.find(ve),t[4]=c,t[5]=l),i&&(l?.enabled??!0)}function ve(e){return e.name===ge}var q={gmail:J(`<svg xmlns="http://www.w3.org/2000/svg" width="192" height="192" fill="none" viewBox="0 0 192 192"><path fill="url(#gmail-2026-a)" d="M146 44h38v110c0 6.627-5.373 12-12 12h-20a6 6 0 0 1-6-6z"/><path fill="#fc413d" d="M46 44H8v110c0 6.627 5.373 12 12 12h20a6 6 0 0 0 6-6z"/><path fill="url(#gmail-2026-b)" d="M39.226 30.456c-8.033-6.752-20.018-5.714-26.77 2.319-6.752 8.032-5.714 20.017 2.319 26.77l76.078 63.949a8 8 0 0 0 10.295 0l76.078-63.95c8.032-6.752 9.07-18.737 2.318-26.77-6.752-8.032-18.737-9.07-26.769-2.318L96 78.18z"/><defs><linearGradient id="gmail-2026-a" x1="165" x2="165" y1="44" y2="166" gradientUnits="userSpaceOnUse"><stop stop-color="#60d673"/><stop offset=".17" stop-color="#42c868"/><stop offset=".39" stop-color="#0ebc5f"/><stop offset=".62" stop-color="#00a9bb"/><stop offset=".86" stop-color="#3c90ff"/><stop offset="1" stop-color="#3186ff"/></linearGradient><linearGradient id="gmail-2026-b" x1="8" x2="184" y1="46.13" y2="46.13" gradientUnits="userSpaceOnUse"><stop offset=".08" stop-color="#ff63a0"/><stop offset=".3" stop-color="#fc413d"/><stop offset=".5" stop-color="#fc413d"/><stop offset=".65" stop-color="#fc413d"/><stop offset=".72" stop-color="#fc5c30"/><stop offset=".86" stop-color="#feb10c"/><stop offset=".91" stop-color="#fec700"/><stop offset=".96" stop-color="#ffdb0f"/></linearGradient></defs></svg>`),"google-calendar":J(`<svg xmlns="http://www.w3.org/2000/svg" width="192" height="192" viewBox="0 0 192 192" fill="none"><path fill="#bbe2ff" d="M32 36.8C32 20.894 44.894 8 60.8 8h70.4C147.106 8 160 20.894 160 36.8v30.4c0 15.906-12.894 28.8-28.8 28.8H60.8C44.894 96 32 83.106 32 67.2z"/><path fill="#3c90ff" d="M19.867 49.392C17.818 33.82 29.94 20 45.645 20h100.71c15.706 0 27.827 13.82 25.778 29.392L166 96l6.133 46.608C174.182 158.18 162.061 172 146.355 172H45.645c-15.706 0-27.827-13.82-25.778-29.392L26 96z"/><mask id="google-calendar-2026-a" width="154" height="152" x="19" y="20" maskUnits="userSpaceOnUse" style="mask-type:alpha"><path fill="#3c90ff" d="M19.867 49.392C17.818 33.82 29.94 20 45.645 20h100.71c15.706 0 27.827 13.82 25.778 29.392L166 96l6.133 46.608C174.182 158.18 162.061 172 146.355 172H45.645c-15.706 0-27.827-13.82-25.778-29.392L26 96z"/></mask><g mask="url(#google-calendar-2026-a)"><path fill="url(#google-calendar-2026-b)" d="M0 0h166v76H0z" transform="matrix(1 0 0 -1 13 172)"/></g><mask id="google-calendar-2026-c" width="154" height="152" x="19" y="20" maskUnits="userSpaceOnUse" style="mask-type:alpha"><path fill="#3186ff" d="M19.867 49.392C17.818 33.82 29.94 20 45.645 20h100.71c15.706 0 27.827 13.82 25.778 29.392L166 96l6.133 46.608C174.182 158.18 162.061 172 146.355 172H45.645c-15.706 0-27.827-13.82-25.778-29.392L26 96z"/></mask><g mask="url(#google-calendar-2026-c)"><path fill="url(#google-calendar-2026-d)" d="M32 27.2C32 16.596 40.596 8 51.2 8h89.6c10.604 0 19.2 8.596 19.2 19.2V96H32z" filter="url(#google-calendar-2026-e)"/></g><path fill="#fff" d="M75.353 133.336q-6.282 0-10.777-2.043t-7.61-5.465q-3.065-3.474-4.342-6.793T51.603 115a2.07 2.07 0 0 1 1.021-1.124l5.67-2.247q.714-.357 1.43-.102.714.204 1.685 2.349 1.022 2.145 2.86 4.546a14.3 14.3 0 0 0 4.495 3.728q2.606 1.328 6.435 1.328 6.18 0 9.807-3.575 3.677-3.575 3.677-9.091 0-5.976-3.882-9.194-3.881-3.269-10.266-3.269h-5.362a1.9 1.9 0 0 1-1.328-.51q-.51-.562-.511-1.277v-5.465q0-.767.51-1.277a1.82 1.82 0 0 1 1.329-.562h4.647q5.721 0 9.194-3.116t3.473-8.07q0-4.902-3.116-7.916t-8.58-3.014q-3.065 0-5.312 1.022a11.5 11.5 0 0 0-3.882 2.86 22.7 22.7 0 0 0-2.809 3.78q-1.174 1.941-1.89 2.145-.714.153-1.379-.255l-5.363-2.605q-.664-.358-.868-1.124t1.226-3.575q1.481-2.86 4.494-5.823a21 21 0 0 1 7.049-4.597q4.035-1.635 9.398-1.634 9.96 0 15.782 5.26 5.823 5.21 5.823 13.791 0 5.925-2.86 10.266-2.81 4.34-7.968 6.13v.204q6.231 1.838 9.806 6.741 3.627 4.853 3.626 11.594 0 9.654-6.742 15.834-6.74 6.18-17.57 6.18zm51.25-1.175q-.868 0-1.533-.664a2.25 2.25 0 0 1-.612-1.583V73.118l-11.492 8.274q-.614.46-1.431.307a1.96 1.96 0 0 1-1.225-.766l-3.32-4.7a1.98 1.98 0 0 1-.358-1.43q.153-.816.817-1.276l20.379-14.557q.256-.204.562-.306.307-.153.715-.153h4.291q.868 0 1.379.613.562.56.562 1.43v69.36q0 .92-.664 1.583a2 2 0 0 1-1.533.664z"/><defs><linearGradient id="google-calendar-2026-b" x1="83" x2="83" y1="76" gradientUnits="userSpaceOnUse"><stop stop-color="#4fa0ff"/><stop offset="1" stop-color="#3186ff"/></linearGradient><linearGradient id="google-calendar-2026-d" x1="89.06" x2="89.06" y1="21.75" y2="96.39" gradientUnits="userSpaceOnUse"><stop stop-color="#a9a8ff"/><stop offset=".8" stop-color="#3c90ff"/></linearGradient><filter id="google-calendar-2026-e" width="152" height="112" x="20" y="-4" color-interpolation-filters="sRGB" filterUnits="userSpaceOnUse"><feFlood flood-opacity="0" result="BackgroundImageFix"/><feBlend in="SourceGraphic" in2="BackgroundImageFix" result="shape"/><feGaussianBlur result="effect1_foregroundBlur_37330_7673" stdDeviation="6"/></filter></defs></svg>`),"google-docs":J(`<svg width="192" height="192" viewBox="0 0 192 192" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`].map(e=>`data:image/svg+xml,${encodeURIComponent(e)}`);var Z=e(f(),1),xe={".svg":`image/svg+xml`,".png":`image/png`,".jpg":`image/jpeg`,".jpeg":`image/jpeg`,".webp":`image/webp`,".gif":`image/gif`,".avif":`image/avif`};async function Se(e,t,n){let r=we(e);if(r==null)return null;try{let e={path:r,hostId:t},i=await n.fetchQuery({queryFn:({signal:t})=>T(`read-file-binary`,{params:e,signal:t}),queryKey:D(`read-file-binary`,e),retry:!1,gcTime:O.FIVE_MINUTES,staleTime:O.INFINITE});return i.contentsBase64?Ce(r,i.contentsBase64):null}catch(e){return c.warning(`Failed to inline local image`,{safe:{},sensitive:{error:e,resolvedImagePath:r}}),null}}function Ce(e,t){return`data:${Te(e)};base64,${t}`}function we(e){if(e==null)return null;let t=e.trim();if(t.length===0)return null;let n=t.toLowerCase();if(n.startsWith(`data:`)||n.startsWith(`http:`)||n.startsWith(`https:`)||n.startsWith(`file:`)||n.startsWith(`vscode-resource:`)||n.startsWith(`vscode-webview:`)||n.startsWith(`vscode-file:`))return null;let r=h(t);return a(r)?r:null}function Te(e){return xe[Z.default.extname(e).toLowerCase()]??`application/octet-stream`}var Q=[`plugins`],Ee=`openai-curated-marketplaces-hidden`,De=4,Oe=new Set,ke=[],Ae=[],je=[],Me=[],Ne=[],$=[],Pe=[l],Fe=[l,u],Ie=`computer-use`,Le=`.tmp/marketplaces/openai-internal-testing`,Re=[`datadog`,`statsig`],ze=new Set([`codex-official`,d,l,u,`openai-primary-runtime`].map(gt)),Be=k(E,({buildFlavor:e,hostId:t,installSuggestionPluginNames:n,isOpenAICuratedRemoteMarketplaceEnabled:r,marketplaceKinds:i,roots:a,shouldHideOpenAICuratedMarketplaces:o},{queryClient:s})=>{let c=it({isOpenAICuratedRemoteMarketplaceEnabled:r,shouldHideOpenAICuratedMarketplaces:o}),l=n==null?nt(t,a,i,r,o):$e(t,a,je,n,r,o);return{queryKey:l,queryFn:async()=>{if(n!=null){let e=await S(`send-cli-request-for-host`,{hostId:t,method:`plugin/installed`,params:{...a.length>0?{cwds:a}:{},installSuggestionPluginNames:n}}),r=at(e.marketplaces,c),i=wt(r,s.getQueryData(l)?.plugins);return{featuredPluginIds:ke,marketplaceLoadErrors:e.marketplaceLoadErrors,marketplaces:vt(r),plugins:await yt({hostId:t,plugins:i,queryClient:s})}}let r=await S(`list-plugins`,i==null?{hostId:t,...a.length>0?{cwds:a}:{},forceRefetch:Oe.has(t)||void 0}:{hostId:t,...a.length>0?{cwds:a}:{},marketplaceKinds:i,forceRefetch:Oe.has(t)||void 0}),o=at(r.marketplaces,c),u=wt(o,s.getQueryData(l)?.plugins),d=e==null?u:ht({buildFlavor:e,plugins:u}),f=We(r.featuredPluginIds).filter(e=>!c.some(t=>e.endsWith(`@${t}`)));return{featuredPluginIds:e==null?f:mt({buildFlavor:e,featuredPluginIds:f}),marketplaceLoadErrors:r.marketplaceLoadErrors,marketplaces:vt(o),plugins:await yt({hostId:t,plugins:d,queryClient:s})}},staleTime:O.SIX_HOURS,gcTime:1/0}});k(E,({hostId:e,marketplaceKind:t},{queryClient:n})=>{let r=[...Q,`marketplace-kind`,e,t];return{queryKey:r,queryFn:async()=>yt({hostId:e,plugins:wt((await S(`list-plugins`,{hostId:e,marketplaceKinds:[t],forceRefetch:Oe.has(e)||void 0})).marketplaces,n.getQueryData(r)),queryClient:n}),staleTime:O.SIX_HOURS}});function Ve(e){return{...Tt(e.summary),description:e.summary.interface?.shortDescription??e.description??null,displayName:e.summary.interface?.displayName??null,marketplaceDisplayName:null,marketplaceName:e.marketplaceName,plugin:e.summary,keywords:e.summary.keywords,...Je({marketplaceName:e.marketplaceName,marketplacePath:e.marketplacePath})}}function He({marketplacePath:e,remoteMarketplaceName:t}){if(e!=null&&t!=null)throw Error(`plugin marketplace request requires one marketplace source`);if(e!=null)return{marketplacePath:e};if(t!=null)return{remoteMarketplaceName:t};throw Error(`plugin marketplace request requires a marketplace source`)}function Ue(e){return e.marketplacePath??`remote:${e.remoteMarketplaceName}`}function We(e){return e.filter(e=>{let t=pt(e).toLowerCase();return!Re.some(e=>t===e||t.startsWith(`${e}-`))})}function Ge(e){return e.marketplacePath==null?Ke(e.plugin):e.plugin.name}function Ke(e){if(e.remotePluginId==null)throw Error(`remote plugin ${e.id} is missing remotePluginId`);return e.remotePluginId}function qe(e){return{...He(e),pluginName:Ge(e)}}function Je({marketplaceName:e,marketplacePath:t}){return t==null?{marketplacePath:null,remoteMarketplaceName:e}:{marketplacePath:t,remoteMarketplaceName:null}}function Ye(e,t,n){let r=(0,F.c)(74),i=n?.enabled!==!1,a;r[0]!==e||r[1]!==i?(a={enabled:i,hostId:e},r[0]=e,r[1]=i,r[2]=a):a=r[2];let o=_e(a)&&i,s=n?.additionalMarketplaceKinds??je,c=n?.installSuggestionPluginNames??null,l=j(`4218407052`),u=ae(e)?.authMethod??null,d;r[3]===u?d=r[4]:(d=be(u),r[3]=u,r[4]=d);let f=d,p=n?.includeRemoteCatalog??!0,m=!l,h;r[5]!==s||r[6]!==p||r[7]!==m?(h=tt({additionalMarketplaceKinds:s,includeRemoteCatalog:p,includeVerticalCatalog:m}),r[5]=s,r[6]=p,r[7]=m,r[8]=h):h=r[8];let g=h,_=y(),v=te(ee),b;r[9]!==e||r[10]!==v?(b=v.includes(e),r[9]=e,r[10]=v,r[11]=b):b=r[11];let S=b,w=t===void 0,T;r[12]===e?T=r[13]:(T={hostId:e},r[12]=e,r[13]=T);let E=o&&S&&w,D;r[14]===E?D=r[15]:(D={enabled:E},r[14]=E,r[15]=D);let O=C(x,T,D),k;r[16]===o?k=r[17]:(k={enabled:o},r[16]=o,r[17]=k);let ne=oe(e,k),re=o&&S,A;r[18]!==e||r[19]!==re?(A={enabled:re,hostId:e},r[18]=e,r[19]=re,r[20]=A):A=r[20];let M=pe(A),ie=o&&S,N;r[21]!==e||r[22]!==ie?(N={enabled:ie,hostId:e},r[21]=e,r[22]=ie,r[23]=N):N=r[23];let P=he(N),se=o&&S,I;r[24]!==e||r[25]!==se?(I={enabled:se,hostId:e},r[24]=e,r[25]=se,r[26]=I):I=r[26];let L=me(I),ce=O.data?.roots,R;r[27]!==ne||r[28]!==e||r[29]!==t||r[30]!==ce?(R=xt({codexHome:ne,hostId:e,rootsOverrideCwd:t,workspaceRoots:ce}),r[27]=ne,r[28]=e,r[29]=t,r[30]=ce,r[31]=R):R=r[31];let le=R,ue=o&&S&&(t!==void 0||O.isFetched),de;r[32]===Symbol.for(`react.memo_cache_sentinel`)?(de=`prod`,r[32]=de):de=r[32];let fe=de,z;r[33]!==e||r[34]!==c||r[35]!==l||r[36]!==g||r[37]!==le||r[38]!==f?(z={buildFlavor:fe,hostId:e,installSuggestionPluginNames:c,isOpenAICuratedRemoteMarketplaceEnabled:l,marketplaceKinds:g,roots:le,shouldHideOpenAICuratedMarketplaces:f},r[33]=e,r[34]=c,r[35]=l,r[36]=g,r[37]=le,r[38]=f,r[39]=z):z=r[39];let B;r[40]===ue?B=r[41]:(B={enabled:ue},r[40]=ue,r[41]=B);let V=C(Be,z,B);if(!o||!S){let e;return r[42]===Symbol.for(`react.memo_cache_sentinel`)?(e={availablePlugins:$,featuredPluginIds:ke,installedPlugins:$,marketplaceLoadErrors:Ae,marketplaces:Ne,errorMessage:null,isLoading:!1,isFetching:!1,refetch:Qe,reload:Ze,forceReload:Xe},r[42]=e):e=r[42],e}let H,U,W,G;r[43]!==M.available||r[44]!==L.available||r[45]!==P.available||r[46]!==V.data?.featuredPluginIds||r[47]!==V.data?.plugins?(H={isComputerUseAvailable:M.available,isExternalBrowserUseAvailable:L.available,isInAppBrowserUseAvailable:P.available},U=V.data?.plugins??$,W=st({plugins:U,...H}),G=ot({featuredPluginIds:V.data?.featuredPluginIds??ke,...H}),r[43]=M.available,r[44]=L.available,r[45]=P.available,r[46]=V.data?.featuredPluginIds,r[47]=V.data?.plugins,r[48]=H,r[49]=U,r[50]=W,r[51]=G):(H=r[48],U=r[49],W=r[50],G=r[51]);let K;r[52]===U?K=r[53]:(K=ct(U),r[52]=U,r[53]=K);let ge=V.data?.marketplaceLoadErrors??Ae,ve=V.data?.marketplaces??Ne,q=V.error?V.error.message:null,ye=w&&O.isLoading||V.isLoading||P.isLoading||L.isLoading||M.isLoading,J=w&&O.isFetching||V.isFetching||M.isFetching,Y;r[54]!==H||r[55]!==V?(Y=async()=>{let e=(await V.refetch()).data?.plugins??$;return{availablePlugins:st({plugins:e,...H}),installedPlugins:ct(e)}},r[54]=H,r[55]=V,r[56]=Y):Y=r[56];let X;r[57]===_?X=r[58]:(X=()=>_(Q),r[57]=_,r[58]=X);let Z;r[59]!==e||r[60]!==_?(Z=async()=>{Oe.add(e),await(async()=>{await _(Q)})().finally(()=>{Oe.delete(e)})},r[59]=e,r[60]=_,r[61]=Z):Z=r[61];let xe;return r[62]!==W||r[63]!==G||r[64]!==K||r[65]!==ge||r[66]!==ve||r[67]!==q||r[68]!==ye||r[69]!==J||r[70]!==Y||r[71]!==X||r[72]!==Z?(xe={availablePlugins:W,featuredPluginIds:G,installedPlugins:K,marketplaceLoadErrors:ge,marketplaces:ve,errorMessage:q,isLoading:ye,isFetching:J,refetch:Y,reload:X,forceReload:Z},r[62]=W,r[63]=G,r[64]=K,r[65]=ge,r[66]=ve,r[67]=q,r[68]=ye,r[69]=J,r[70]=Y,r[71]=X,r[72]=Z,r[73]=xe):xe=r[73],xe}async function Xe(){}async function Ze(){}async function Qe(){return{availablePlugins:$,installedPlugins:$}}function $e(e,t,n=je,r=null,i=!1,a=!1){return r==null?nt(e,t,tt({additionalMarketplaceKinds:n,includeRemoteCatalog:!0,includeVerticalCatalog:!i}),i,a):et([...Q,e,t,`installed`,r,`curated-marketplace`,rt(i)],a)}function et(e,t){return t?[...e,Ee]:e}function tt({additionalMarketplaceKinds:e,includeRemoteCatalog:t,includeVerticalCatalog:n}){return t&&!n&&e.length===0?null:n?[`local`,`vertical`,...e]:[`local`,...e]}function nt(e,t,n,r,i){let a=rt(r);return et(n==null?[...Q,e,t,`curated-marketplace`,a]:[...Q,e,t,`marketplace-kinds`,n,`curated-marketplace`,a],i)}function rt(e){return e?u:l}function it({isOpenAICuratedRemoteMarketplaceEnabled:e,shouldHideOpenAICuratedMarketplaces:t}){return t?Fe:e?Pe:Me}function at(e,t){return t.length===0?e:e.filter(e=>!t.includes(e.name))}function ot({featuredPluginIds:e,...t}){return e.filter(e=>lt(e,t))}function st({plugins:e,...t}){return e.filter(e=>lt(e.plugin.id,t))}function ct(e){return e.filter(e=>e.plugin.installed)}function lt(e,{isComputerUseAvailable:t,isExternalBrowserUseAvailable:n,isInAppBrowserUseAvailable:r}){return pt(e)===`browser`?r||n:!(!r&&ut(e)||!n&&dt(e)||!t&&ft(e))}function ut(e){let t=pt(e);return t===`browser`||t===`browser-use`}function dt(e){let t=pt(e);return t===`chrome`||t===`chrome-dev`||t===`chrome-internal`}function ft(e){return pt(e)===Ie}function pt(e){let t=e.indexOf(`@`);return t===-1?e:e.slice(0,t)}function mt({buildFlavor:e,featuredPluginIds:t}){let n=_(e);return t.filter(e=>{let t=s(e);return t==null||!i(t)||t===n})}function ht({buildFlavor:e,plugins:t}){let n=_(e);return t.filter(e=>!i(e.marketplaceName)||e.marketplaceName===n)}function gt(e){return e.trim().toLowerCase().replace(/[^a-z0-9]+/g,`-`).replace(/^-+|-+$/g,``)}function _t(e){return ze.has(gt(e))}function vt(e){let t=new Map;for(let n of e){let e=`${n.name}\u0000${n.path??``}`;if(t.has(e))continue;let r=_t(n.name);t.set(e,{displayName:n.interface?.displayName??null,isBuiltIn:r,name:n.name,path:n.path,pluginCount:n.plugins.length})}return Array.from(t.values()).sort((e,t)=>{let n=e.displayName?.trim()||e.name,r=t.displayName?.trim()||t.name;return n.localeCompare(r)})}async function yt({hostId:e,plugins:t,queryClient:n}){let r=[...t];async function i(a){let o=t[a];if(o==null)return;let[s,c,l]=await Promise.all([bt(o.composerIconPath,e,n),bt(o.logoPath,e,n),bt(o.logoDarkPath,e,n)]);(s!=null||c!=null||l!=null)&&(r[a]={...o,composerIconPath:s??o.composerIconPath,logoDarkPath:l??o.logoDarkPath,logoPath:c??o.logoPath,plugin:o.plugin.interface?{...o.plugin,interface:{...o.plugin.interface,composerIcon:s??o.plugin.interface.composerIcon,logo:c??o.plugin.interface.logo,...l==null?{}:{logoDark:l}}}:o.plugin}),await i(a+De)}return await Promise.all(Array.from({length:Math.min(De,t.length)},(e,t)=>i(t))),r}async function bt(e,t,n){return Se(e,t,n)}function xt({codexHome:e,hostId:t,rootsOverrideCwd:n,workspaceRoots:r}){let i=t===`local`&&e!=null?v(e,Le):null;return St([...typeof n==`string`?[n]:n??r??[],...i==null?[]:[i]],e)}function St(e,t){return Array.from(new Set(e.map(e=>e.trim()).filter(e=>a(e)&&Ct(e,t))))}function Ct(e,t){return t==null?!0:m(t)||o(t)?m(e)||o(e):e.startsWith(`/`)&&!e.startsWith(`//`)}function wt(e,t=$){let n=new Map,r=new Set;for(let t of e)for(let e of t.plugins){e.installed||r.add(e.id);let i={...Tt(e),description:e.interface?.shortDescription??null,displayName:e.interface?.displayName??null,marketplaceDisplayName:t.interface?.displayName??null,marketplaceName:t.name,plugin:e,keywords:e.keywords,...Je({marketplaceName:t.name,marketplacePath:t.path})},a=n.get(e.id);if(a==null){n.set(e.id,i);continue}let o=a;(a.plugin.installed&&!e.installed||a.plugin.installed===e.installed&&a.plugin.interface==null&&e.interface!=null)&&(o=i),a.plugin.installed&&!e.installed&&n.delete(e.id);let s=null;if(a.plugin.installed?s=a.plugin:e.installed&&(s=e),s==null){n.set(e.id,o);continue}n.set(e.id,{...o,plugin:{...o.plugin,enabled:s.enabled,installed:!0,installPolicy:s.installPolicy,localVersion:s.localVersion,remotePluginId:o.plugin.remotePluginId??s.remotePluginId}})}let i=new Map(t.map(e=>[e.plugin.id,e])),a=!1,o=Array.from(n.values()).map(e=>{let t=i.get(e.plugin.id);return!e.plugin.installed||t==null||r.has(e.plugin.id)?e:(a||=e.marketplaceName!==t.marketplaceName||e.marketplacePath!==t.marketplacePath,{...t,plugin:{...e.plugin,id:t.plugin.id,interface:t.plugin.interface??e.plugin.interface,keywords:t.plugin.keywords??e.plugin.keywords,name:t.plugin.name,remotePluginId:t.plugin.remotePluginId??e.plugin.remotePluginId,shareContext:t.plugin.shareContext??e.plugin.shareContext,source:t.plugin.source}})});if(!a)return o;let s=new Map(o.map(e=>[e.plugin.id,e]));return[...t.flatMap(e=>{let t=s.get(e.plugin.id);return s.delete(e.plugin.id),t==null?[]:[t]}),...s.values()]}function Tt(e,t){let n=e.interface,r=n?.composerIcon??n?.composerIconUrl,i=n?.logo??n?.logoUrl,a=n?.logoDark??n?.logoUrlDark,o=ye(e),s=i!=null||a!=null,c=r??(s?null:o),l=s?i??a??null:o??t?.logoUrl??t?.logoUrlDark??null;return{composerIconPath:c,logoDarkPath:s?a??null:o??t?.logoUrlDark??t?.logoUrl??null,logoPath:l}}export{_e as _,it as a,R as b,He as c,yt as d,Ye as f,be as g,Se as h,wt as i,qe as l,we as m,Ve as n,Tt as o,Ce as p,at as r,Ue as s,Q as t,Ge as u,z as v,ce as y};